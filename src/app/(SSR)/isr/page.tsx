...
export const metadata: Metadata = {
	title: "Incremental Static Regeneration - NextJS 14 Image Galleria", //url hover title
};
...
export default async function dynamicPage() {
	...
	return (
		<div className="d-flex flex-column align-items-center">
			<Alert>
				Incremental Static Regeneration, image is cached for 15 seconds, after
				that time refreshing generates a new image
			</Alert>
			<Image
				src={image.urls.raw}
				width={width}
